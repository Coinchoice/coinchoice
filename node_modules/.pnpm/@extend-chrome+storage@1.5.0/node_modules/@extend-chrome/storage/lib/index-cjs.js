...
var chromep = require('chrome-promise');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var chromep__default = /*#__PURE__*/_interopDefaultLegacy(chromep);
...
const getStorageArea = (area) => {
    switch (area) {
        case 'local':
            return chromep__default['default'].storage.local;
        case 'sync':
            return chromep__default['default'].storage.sync;
        case 'managed':
            return chromep__default['default'].storage.managed;
        default:
